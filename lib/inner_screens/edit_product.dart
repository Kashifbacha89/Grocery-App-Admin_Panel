      ...
      try{
        ...
        if(_pickedImage != null){
          final ref = FirebaseStorage.instance
              ...
              .child('${widget.id}.jpg');
          //await ref.putData(kIsWeb?webImage!:_pickedImage);
          if(kIsWeb){
        ...
        await FirebaseFirestore.instance.collection('products').doc(widget.id).update({
          ...
          'imageUrl':
          _pickedImage == null ? widget.imageUrl : _imageUrl.toString(),
                                ...
                                onPressed: () async {
                                  GlobalMethods.warningDialog(
                                      ...
                                      fct: () async {
                                        ...
                                        await Fluttertoast.showToast(msg: 'product has been deleted',
                                        gravity: ToastGravity.CENTER,
                                          toastLength: Toast.LENGTH_LONG,
                                          timeInSecForIosWeb: 1,
