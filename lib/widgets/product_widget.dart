...
class _ProductWidgetState extends State<ProductWidget> {
  ...
  //fetch User products  from Firestore database
  Future<void> getUserData() async {
    try {
      final DocumentSnapshot productDocs =
          await FirebaseFirestore.instance.collection('products').doc(widget.id).get();
      if(productDocs==null){
        return;
      }else{
        title = productDocs.get('title');
        productCat = productDocs.get('productCategoryName');
        imageUrl= productDocs.get('imageUrl');
        price =productDocs.get('price');
        isOnSale= productDocs.get('isOnSale');
        isPiece = productDocs.get('isPiece');
      }
    } catch (error) {
...
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:grocery_admin_panel/inner_screens/edit_product.dart';
